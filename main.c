...
int main(void)
{
    ...
    PORTB = 0b00010001;  // Setting PORTB to allow motors to run with the value that they are given from OC1,OC2
    ...
    while (1)
    {
        tstCh = getU2();    // Display numerical number of the characters received on LED's one pairing to phone
        PORTA = tstCh;
